...
int part_01_basics()
{
    ...
    */
    ...
    try
    {
        ...
        std::cout << std::format("Thor's parents and grand-parents: {0}.", r_thorsParentsAndGrandparents[0]->data) << std::endl;
        ...
        std::cout << std::format("Thor's weird cousin: {0}.", r_thorsWeirdCousin[0]->data) << std::endl;
    }
    catch (std::exception const& ex)
    {
        std::cout << "Error while loading: " << ex.what() << std::endl;
